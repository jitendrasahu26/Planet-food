...
public class SplashScreenFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setText("Planet Food");

        jProgressBar1.setBackground(new java.awt.Color(61, 76, 102));
        jProgressBar1.setFont(new java.awt.Font("Microsoft JhengHei UI", 1, 18)); // NOI18N

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/planetfood/gui/food_png_523023.png"))); // NOI18N
