...
public class ViewProductFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        buttonGroup1.add(jrbvsp);
        jrbvsp.setFont(new java.awt.Font("Microsoft JhengHei UI", 1, 13)); // NOI18N
        jrbvsp.setText("View Single Product");

        buttonGroup1.add(jrbvap);
        jrbvap.setFont(new java.awt.Font("Microsoft JhengHei UI", 1, 13)); // NOI18N
        jrbvap.setText("View All Products");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
        SingleProductDetailsPanel spdp=new SingleProductDetailsPanel();
       spdp.setVisible(true);
       this.dispose();
        }
        if(jrbvap.isSelected())
        {
